...
-- CREATE CATALOG IF NOT EXISTS medallion_architecture;

-- COMMAND ----------

-- Set the current catalog
USE CATALOG medallion_architecture;
...
ON CATALOG medallion_architecture
TO `account users`;

-- COMMAND ----------

--- Check grants on the quickstart catalog
SHOW GRANT ON CATALOG medallion_architecture;
